<form on:submit|preventDefault={savePassword} class="f-column gap-3">
    <TextInput id="old-password" bind:value={password} type="password">
        Old password
    </TextInput>
    <TextInput id="new-password" bind:value={newPassword} type="password">
        New password
    </TextInput>
    <TextInput id="new-password-confirm" bind:value={newPasswordConfirm} type="password">
